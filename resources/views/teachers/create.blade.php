...
@section('main-content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Add Teacher') }}</h1>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('students.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('MiddleName') is-invalid @enderror" id="MiddleName" name="MiddleName" value="{{ old('MiddleName') }}" required autocomplete="FirstName" autofocus>
                            @error('MiddleName')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
