...
@section('main-content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Edit Teacher') }}</h1>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="POST" action="{{ route('students.update') }}">
                        ...
                        <div class="form-group">
                            <label for="FirstName">{{ __('Middle Name') }}</label>
                            <input type="text" value="{{ $student->MiddleName }}" class="form-control @error('MiddleName') is-invalid @enderror" id="MiddleName" name="MiddleName" value="{{ old('MiddleName') }}" required autocomplete="MiddleName" autofocus>
                            @error('LastName')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
